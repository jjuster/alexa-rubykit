module AlexaRubykit
  ...
  class Device
    ...
    def clock_text_support?
      !@device.nil? && !@device['supportedInterfaces'].nil? && !@device['supportedInterfaces']['Alexa.Presentation.APLT'].nil? && !@device['Viewports'].nil? && !@device['Viewports'].detect{|vp| vp['type'] == 'APLT' && vp['characterFormat'] == 'SEVEN_SEGMENT' }.nil?
    end    
