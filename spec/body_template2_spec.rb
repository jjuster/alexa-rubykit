...
describe 'Request handling' do
  it 'validate json format' do
    ...
    expect(template_json["template"]["image"]["sources"][0]).to include({
      ...
      "size" => sample_json["template"]["image"]["sources"][0]["size"],
      "widthPixels" => sample_json["template"]["image"]["sources"][0]["widthPixels"],
      "heightPixels" => sample_json["template"]["image"]["sources"][0]["heightPixels"]
    })
  end
end
